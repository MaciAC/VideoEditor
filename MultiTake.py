...
class MultiTake:
    ...
    def __init__(self, base_folder:str, force_recreation):
        ...
        self.synchonizer = Synchronizer(self.file_manager.create_normalized_audiofiles())
        self.file_manager.set_offsets(self.synchonizer.run())
        self.sync_audio_path, self.sync_video_paths = self.file_manager.cut_videos_based_on_offsets()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--folder',action='store',type=str,required=True,dest="folder")
